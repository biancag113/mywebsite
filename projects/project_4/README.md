# Mini Project #4: Ruby on Rails with React

## Overview

You will build a Rails & React App for one more repetition to solidify this unit and prepare you for your final project.
...
* **React frontend**: Serve a React frontend that consumes your Rails API. The React frontend must be deployed online via Heroku or (more likely) GitHub Pages.
...
_We will do quick approval meetings in the first half of class on Wednesday, May 6th_

## How to Submit Your Project
Your project is due on Wednesday, May 13th at 8:00 pm EST (1.5 hours after class starts).
